jQuery(document).ready(function ($) {
    ...
    if ( $table_items.length > 0 ) {
            ...
            $table_items.each(function( index ) {
                $(this).find('.title > strong').after('<span class="close" data-toggler><span class="dashicons dashicons-arrow-right"></span><span class="dashicons dashicons-arrow-down"></span></span>');
            });
